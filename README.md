...
These are all the version which is going to be developed with bugs as well as resolving issues in it...<br><br>
...
If you want python file which you want to upgrade it then you may use Excel Forensic Optimizer v10.8.py where you may find all the code....<br><br>
